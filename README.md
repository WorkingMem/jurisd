...
> | **both**            | both of the above     | -              | Best coverage: source runs first, Exa fills the gaps it misses.                                                   | -                                                                                                                                           |
...
>
> Resolution order: AustLII and removed.invalid, direct citation URL when present, Exa,
