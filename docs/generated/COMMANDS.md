...
| `jade-lookup`           | `source`  | `network_read`        | `jade_lookup`           | Look up jade.io article metadata or citation URL.          |
...
- Command id: `source.jadeLookup`
- Group: `source`
- Side effect: `network_read`
- Stability: `stable`
- MCP tool: `jade_lookup`
- Result contract: `source.jadeLookup.v1`
