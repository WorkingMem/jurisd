...
| `source_lookup` | stable | Source article or citation lookup |
...
export const COMMAND_CONTRACTS: CommandContract[] = [
  ...
  makeContract("source.sourceLookup", "source-lookup", "source_lookup", "source", "network_read", [], ["articleId"], [], [], "Look up source article metadata or citation URL.", "jurisd source-lookup --by citation --citation '[2008] NSWSC 323'"),
