...
export function formatCapabilityProbeSummary(caps) {
    ...
    lines.push(caps.local_embeddings
    ...
    lines.push(caps.domain_adapter.configured && caps.domain_adapter.reachable
    ...
    lines.push("  Live AustLII, Jade, Exa, and citation search are checked when their search commands run.");
    return lines.join("\n");
}
